...
function getComments(search, page)
{
    ...
    $.getJSON(url, function(json){
          ...
          if (total == "0"){
             $("#total").text("标记成功，过会再来看看吧~");
          }
          else{
              document.getElementById("total").innerHTML = "共找到" + json.total[0] + "条结果：" + (page * 10 + 1) + "-" + (page * 10 + 10);
              var str = "";
              ...
              str += $.commMakePages({num: page + 1,count: total,size: 10,"long": 5});
